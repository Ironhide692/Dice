...
var timesToPlay = new window.prompt("How many times you want to play?")
...
function whoWon() {
    ...
    document.querySelector("h4").innerHTML = "your balance is: " + balance;
}
...
function input() {
  ...
  if (userInput.value > 1){
   message.innerHTML = "you selected to play " + userInput.value + " times";
    ...
    letsPlay();
    message.innerHTML = "you selected to play " + userInput.value + " time";
  }
}
